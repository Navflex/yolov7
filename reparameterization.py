...
ckpt = torch.load('runs/train/yolov7-tiny-custom/weights/best.pt', map_location=device)
# reparameterized model in cfg/deploy/*.yaml
model = Model('cfg/deploy/yolov7-tiny_custom.yaml', ch=3, nc=5).to(device)

with open('cfg/deploy/yolov7-tiny_custom.yaml') as f:
...
torch.save(ckpt, 'runs/train/yolov7-tiny-custom/weights/yolov7-tiny_custom_deploy.pt')
